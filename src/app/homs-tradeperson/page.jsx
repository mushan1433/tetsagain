    ...
    return (
        <div className='homs-tradeperson'>
            <section className="relative">
                <div className="w-3/5 m-auto flex justify-between bg-white my-20 relative after:content[''] after:w-[calc(100%-80px)] after:h-[1px] after:absolute after:top-7 after:right-0 after:bg-[#C8C8C8]">
            ...
            <div>
                <section className=" bg-white relative pt-4 pl-10" style={{ display: isNext ? "none" : "block" }}>
                    <div className="absolute top-3 right-0 mt-4 bg-gray-200 h-full w-1/3 z-10">
                    </div>
                    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-2">
                        <div className="my-auto">
                            ...
                            <div>
                                <div class="flex flex-col mt-8">
                                    <div>
                                        <label className="uppercase text-sm font-bold opacity-70 text-pink-600">Enter postcode</label>
                                        <div className="flex gap-2">
                                            <input type="text" placeholder="W2 5QX" className="py-2 px-2 mt-2 mb-4 w-1/3 bg-[#F1F1F1] rounded border-2 border-[#F1F1F1] focus:border-slate-200 focus:outline-none" />
                                            <input type="submit" class="py-2 px-5 mx-2 mt-2 mb-4 bg-[#FB2A63] text-white text-sm font-extralight hover:bg-ping-500 cursor-pointer ease-in-out duration-300" value="Find Address" />
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <div class="flex flex-col mt-2">
                                                <div>
                                                    <label className="uppercase text-sm font-bold opacity-70 text-pink-600">Select an address</label>
                                                    <div className="flex">
                                                        <select class="w-1/2 py-2 px-3 mt-2 mb-4  bg-[#F1F1F1] border-2 border-[#F1F1F1] focus:border-slate-200 focus:outline-none">
                        ...
                        <div className="w-full bg-[#112F51] px-14 relative z-20">
                            <div className="mx-auto w-full max-w-[550px] px-12 py-8">
                ...
                <div style={{ display: isNext ? "block" : "none" }}>
                    ...
                    <section className="mt-20 relative">
                        <div className="absolute top-3 left-0 mt-4 bg-gray-200 h-full w-1/3 z-10">
                        </div>
                        <div className="absolute top-3 right-0 mt-4 bg-gray-200 h-full w-1/3 z-10">
                        </div>
                        <div className="mt-16 ml-20 relative z-20 py-8">
                            <div className="grid max-w-screen-xl gap-4 px-4 py-8 mx-auto lg:gap-8  lg:py-8 lg:grid-cols-2 text-white">
                                <div className=" bg-[#112F51] p-8">
                                    <div className="flex gap-8 mb-4">
                                        <img className="flex-shrink-0" src="./phone.png" alt="phone" />
                                        <div>
                                    ...
                                    <div className="text-center">
                                        <p className="text-white text-lg font-medium mt-12">
                                            (207) 555-0119
                                        </p>
                                    </div>
                                </div>
                                <div className=" bg-[#112F51] p-8">
                                    <div className="grid gap-1 grid-cols-12">
                                        <div className="col-span-2">
                                            <img src="./envelope.png" alt="" srcset="" />
                                        </div>
            ...
            <div className="font-raleway w-fit h-fit fixed top-2/4 left-2/4 translate-y-[-50%] translate-x-[-50%] z-40" style={{ display: show ? "block" : "none" }}>
                <div className='w-[420px] bg-[#2A2A35] text-white text-center flex items-center justify-center flex-col rounded-xl py-10 pb-7 px-10 absolute top-2/4 left-2/4 translate-y-[-50%] translate-x-[-50%]'>
